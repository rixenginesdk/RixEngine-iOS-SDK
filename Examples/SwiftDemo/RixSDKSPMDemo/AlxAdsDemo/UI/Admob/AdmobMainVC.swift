...
class AdmobMainVC: BaseUIViewController, DemoDeferredSDKInitializing {
    ...
    private let adTypes: [MenuItem] = [
        MenuItem(title: NSLocalizedString("banner_ad", comment: ""),
                 ...
                 viewControllerType: AdmobBannerVC.self),
        MenuItem(title: NSLocalizedString("rewardVideo_ad", comment: ""),
                 ...
                 viewControllerType: AdmobRewardVideoVC.self),
...
extension AdmobMainVC: UITableViewDataSource {
...
extension AdmobMainVC: UITableViewDelegate {
