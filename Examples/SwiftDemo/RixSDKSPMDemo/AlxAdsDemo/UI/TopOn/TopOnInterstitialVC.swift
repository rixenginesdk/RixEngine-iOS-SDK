...
//        logMessage("\(TAG) interstitialDidShowForPlacementID:\(placementID)")
//    }
//
//    func interstitialDidClick(forPlacementID placementID: String, extra: [AnyHashable : Any]) {
//        logMessage("\(TAG) interstitialDidClickForPlacementID:\(placementID)")
//    }
//
//    func interstitialDidClose(forPlacementID placementID: String, extra: [AnyHashable : Any]) {
//        logMessage("\(TAG) interstitialDidCloseForPlacementID:\(placementID)")
//    }
//}
