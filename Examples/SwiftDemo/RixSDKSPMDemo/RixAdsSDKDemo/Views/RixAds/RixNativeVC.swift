...
class RixNativeVC: BasicUIViewController {

    private let TAG = "Rix-native:"
    ...
    @objc func loadAd() {
        ...
        let loader = AlxNativeAdLoader(adUnitID: AdsConfig.Alx_Native_Ad_Id)
...
extension RixNativeVC: AlxNativeAdLoaderDelegate {
...
extension RixNativeVC: AlxNativeAdDelegate {
