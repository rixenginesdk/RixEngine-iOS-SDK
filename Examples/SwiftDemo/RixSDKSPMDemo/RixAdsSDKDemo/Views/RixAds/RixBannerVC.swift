...
class RixBannerVC: BasicUIViewController {

    private let TAG = "Rix-banner:"
    ...
    @objc func preloadAd() {
        ...
        bannerView2?.loadAd(adUnitId: AdsConfig.Alx_Banner_Ad_Id)
    }
...
extension RixBannerVC: AlxBannerViewAdDelegate {
