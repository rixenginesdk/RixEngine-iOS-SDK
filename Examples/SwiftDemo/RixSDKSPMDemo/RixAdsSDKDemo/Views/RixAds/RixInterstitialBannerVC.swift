...
class RixInterstitialBannerVC: BasicUIViewController {

    private let TAG = "Rix-interstitial-banner:"
    ...
    @objc func loadAd() {
        ...
        interstitialAd.loadAd(adUnitId: AdsConfig.Alx_Interstitial_Banner_Ad_Id)
    }
...
extension RixInterstitialBannerVC: AlxInterstitialAdDelegate {
