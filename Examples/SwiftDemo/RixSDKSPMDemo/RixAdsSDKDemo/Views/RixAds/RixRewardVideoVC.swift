...
class RixRewardVideoVC: BasicUIViewController {

    private let TAG = "Rix-rewardVideo:"
    ...
    @objc func loadAd() {
        ...
        rewardAd.loadAd(adUnitId: AdsConfig.Alx_Reward_Video_Ad_Id)
    }
...
extension RixRewardVideoVC: AlxRewardVideoAdDelegate {
