...
class RixInterstitialVideoVC: BasicUIViewController {

    private let TAG = "Rix-interstitial-video:"
    ...
    @objc func loadAd() {
        ...
        interstitialAd.loadAd(adUnitId: AdsConfig.Alx_Interstitial_Video_Ad_Id)
    }
...
extension RixInterstitialVideoVC: AlxInterstitialAdDelegate {
