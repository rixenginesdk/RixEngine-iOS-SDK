...
class AdmobNativeVC: BasicUIViewController {
    ...
    func loadAd() {
        ...
        adLoader = AdLoader(adUnitID: AdsConfig.Admob_Native_Ad_Id, rootViewController: self, adTypes: [.native], options: [multipleAdOptions])
