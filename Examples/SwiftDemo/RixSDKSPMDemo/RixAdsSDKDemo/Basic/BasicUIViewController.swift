...
public class BasicUIViewController: UIViewController {
    ...
    public func showAutoDismissTip(message: String, duration: TimeInterval = 1.4) {
        showAutoDismissTip(message, duration: duration)
    }
