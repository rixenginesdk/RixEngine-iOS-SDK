...
@interface TopOnNativeVC () <ATAdLoadingDelegate, ATNativeADDelegate>
...
@implementation TopOnNativeVC

- (void)viewDidLoad {
    [super viewDidLoad];
    self.TAG = @"TopOn-native:template:";
    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.title = NSLocalizedString(@"topOn_native", @"");
...
- (void)renderAdUI {
    ...
    [self.nativeAdOffer rendererWithConfiguration:config selfRenderView:nil nativeADView:nativeAdView];
...
- (void)destroyAd {
    if (self.adView) {
        ...
        // [self.adView destroyNative]; // Note: check if this exists in ObjC SDK
        self.adView = nil;
    }
}
