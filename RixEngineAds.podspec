Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |core|
    core.name             = 'Core'
    core.vendored_frameworks = 'AlxAds.xcframework'
  ...
  s.subspec 'AdmobAdapter' do |admob|
    admob.source_files = 'custom_adapter/AdmobAdapter/Swift/**/*.swift'
    admob.dependency 'RixEngineAds/Core'
    admob.dependency 'Google-Mobile-Ads-SDK', '12.6.0'
  end

  s.subspec 'AdmobAdapterOC' do |admob_oc|
    admob_oc.source_files = 'custom_adapter/AdmobAdapter/Objc/**/*.{h,m}'
  ...
  s.subspec 'MaxAdapter' do |max|
    max.source_files = 'custom_adapter/MaxAdapter/Swift/**/*.swift'
    max.dependency 'RixEngineAds/Core'
    max.dependency 'AppLovinSDK'
  end

  s.subspec 'MaxAdapterOC' do |max_oc|
    max_oc.source_files = 'custom_adapter/MaxAdapter/Objc/**/*.{h,m}'
  ...
  s.subspec 'TopOnAdapter' do |topon|
    topon.source_files = 'custom_adapter/TopOnAdapter/Swift/6.5.x/**/*.swift'
  ...
  s.subspec 'TopOnAdapterOC' do |topon_oc|
    topon_oc.source_files = 'custom_adapter/TopOnAdapter/Objc/6.5.x/**/*.{h,m}'
  ...
  s.subspec 'UnityLevelPlayAdapter' do |unity|
    unity.source_files = 'custom_adapter/UnityLevelPlayAdapter/Swift/**/*.swift'
    unity.dependency 'RixEngineAds/Core'
    unity.dependency 'IronSourceSDK'
  end

  s.subspec 'UnityLevelPlayAdapterOC' do |unity_oc|
    unity_oc.source_files = 'custom_adapter/UnityLevelPlayAdapter/Objc/**/*.{h,m}'
